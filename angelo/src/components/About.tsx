...
const About = () => (
    <section className=" min-h-1.5 my-12 px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center lg:items-start text-center lg:text-left">
        <div className="lg:flex-2 flex flex-col items-center justify-center text-center">
        ...
        <div className="mt-6 lg:mt-0 lg:ml-6">
            <Image src="/Angeloprofile.png" alt="Angelo" width={200} height={200}
